...
catch(PDOException $e)
{
    ...
    if (isset($_POST['cid']) && isset($_POST['chequeno']) && isset($_POST['amount']) ) 
    {
        ...
        $stmt = $pdo->prepare("
            insert into ebank(cid,amount,ebankid,tdate) VALUES (:cid,:amount,:chequeno,:tdate)
        ");
...
<html>
<head>
	<title>Anmol paridhan by e banking</title>
...
<body>
	...
	<div class="login">
    <h1>E-banking Detail</h1>
    <form method="post">
        <input type="number" name="cid" placeholder="Enter Company Id" required="required" />
        <input type="text" name="chequeno" placeholder="Enter E-Banking Id" required="required" />
